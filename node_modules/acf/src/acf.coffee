...
class Acf
  ...
  # 计算访问者对资源的最终权限值
  # @param resource {Object} 资源
  #   @param resource.type {String} 资源类型
  #   @param resource.id {String} 资源id
  #   @param resource.ancestors {Array} 资源的祖先的数组，由近到远排序。
  # @param accessorId {String} 访问者id
  # @param callback {Function} 回调函数
  calculate : (resource, accessorId, callback) ->
    @_calculator.calculate resource, accessorId, callback

  # 批量计算访问者对资源的最终权限值
  # @param resources {Array Resource} 资源数组
  # @param accessorId {String} 访问者id
  # @param callback {Function} 回调函数
  ...
  grantAssignmentsOfResource : (resource, assignments, callback) ->
    @_assignmentManager.grantAssignmentsOfResource resource, assignments, callback
