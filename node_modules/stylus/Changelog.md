...
==================
  ...
  * Changed: treat -/+ operations with percentages as lighten()/shade-color(). 
Closes #401
...
==================
  ...
  * Added support for `rgba - 25%` to shade-color
...
==================
  ...
  * Removed {`shade-color`,`lighten`}`-by()` BIFs
