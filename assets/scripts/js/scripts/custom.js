...
jQuery(document).ready(function ($) {
    ...
    $('.widget_MYTHEME-number-counter').one('inview', startKnob);
    ...
    $(window).load(function () {
        ...
        $(".MYTHEME-preloader").fadeOut("slow");
    });
    ...
    if($('body').hasClass('page-template-tpl-home')){
        $('#fullpage').fullpage({
            ...
            //Custom selectors
            sectionSelector: '.MYTHEME-main-section',
    ...
    function MYTHEMEFocusForce(focEl){
        var _doc = document;
        setTimeout( function() {
    ...
    $('body').on('click keypress','.btn-transparent-toggle', function(){
        ...
        $('.site-footer').addClass('scroll-show').addClass('fp-show');
        MYTHEMEFocusForce('.main-navigation ul li:first-child a');
    });
