...
class THEMENAME_Dark_Mode {
	...
	public function customizer_controls( $wp_customize ) {
		...
		include_once get_theme_file_path( 'inc/classes/class-THEMENAME-customize-notice-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
