...
<div class="heatbox customizer-metabox">
	...
	<h2>
		<?php _e( 'Customizer Settings', 'THEMENAME' ); ?>
	</h2>
	...
	<ul class="customizer-list">
		...
		<li>
			<h3>
				<?php _e( 'Launch WordPress Customizer', 'THEMENAME' ); ?>
			</h3>
			<p>
				<?php _e( 'Explore all of the THEMENAME features.', 'THEMENAME' ); ?>
			</p>
			<a href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" target="_blank" class="button button-larger button-primary"><?php _e( 'Customize', 'THEMENAME' ); ?></a>
		</li>
