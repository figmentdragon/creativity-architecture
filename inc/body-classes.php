...
if ( ! function_exists( 'scripts' ) ) {
	...
	function scripts() {
		...
		if ( $magic_cursor != 'disable' ) {
			wp_enqueue_style( 'magic-mouse', esc_url( $dir_uri ) . "/css/magic-mouse.min.css", false, 'VERSION', 'all' );
			wp_enqueue_script( 'magic-mouse', esc_url( $dir_uri ) . "/js/jQuery/magic-mouse.min.js", array( 'jquery'), 'VERSION', true );
		}
	}
}
