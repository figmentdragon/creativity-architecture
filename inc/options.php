...
function metaboxes() {
	...
	// Add options metabox.
	add_meta_box( 'themename', __( 'Template Settings', 'THEMENAME' ), 'options_metabox_callback', $post_types, 'side', 'default' );

	// Add sidebar metabox.
	add_meta_box( 'sidebar', __( 'Sidebar', 'THEMENAME' ), 'sidebar_metabox_callback', $post_types, 'side', 'default' );
...
function options_metabox_callback( $post ) {
	...
	<div>
		...
		<label for="layout-global"><?php _e( 'Inherit Global Settings', 'THEMENAME' ); ?></label>
		<?php
		if ( ! is_premium() ) {
	...
	<div>
		...
		<label for="layout-full-width"><?php _e( 'Full Width', 'THEMENAME' ); ?></label>
	</div>

	<div>
		<input id="layout-contained" type="radio" name="options[]" value="contained" class="layout-option" <?php checked( $width_type, 'contained' ); ?> />
		<label for="layout-contained"><?php _e( 'Contained', 'THEMENAME' ); ?></label>
	</div>
	...
	<div>
		...
		<label for="layout-custom-width"><?php _e( 'Custom Width', 'THEMENAME' ); ?></label>
	</div>
...
function post_list_columns( $columns ) {
	...
	$columns['layout'] = __( 'Layout', 'THEMENAME' );
...
function post_list_custom_column( $column_name, $post_id ) {
	...
	if ( in_array( 'full-width', $post_options, true ) ) {
		...
		$column_value = __( 'Full Width', 'THEMENAME' );
	} elseif ( in_array( 'contained', $post_options, true ) ) {
		$layout = 'contained';

		$column_value = __( 'Contained', 'THEMENAME' );
	} else {
		$layout = 'layout-global';

		$column_value = __( 'Inherit Global Settings', 'THEMENAME' );
	}
