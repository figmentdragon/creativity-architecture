...
if ( ! function_exists( 'get_defaults' ) ) {
	...
	function get_defaults() {
		...
		return apply_filters( 'option_defaults', $defaults );
	}
}

if ( ! function_exists( 'get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function get_color_defaults() {
		...
		return apply_filters( 'color_option_defaults', $color_defaults );
	}
}
...
if ( ! function_exists( 'get_default_fonts' ) ) {
	 ...
	 */
	function get_default_fonts( $filter = true ) {
		$font_defaults = array(
			'font_body' => 'Open Sans',
			'font_body_category' => '',
		...
		if ( $filter ) {
			return apply_filters( 'font_option_defaults', $font_defaults );
		}
...
if ( ! function_exists( 'spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function spacing_get_defaults( $filter = true ) {
		...
		if ( $filter ) {
			return apply_filters( 'spacing_option_defaults', $spacing_defaults );
		}
...
if ( ! function_exists( 'get_default_color_palettes' ) ) {
	/**
	...
	function get_default_color_palettes() {
		...
		return apply_filters( 'default_color_palettes', $palettes );
	}
}

if ( ! function_exists( 'typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 */
	function typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'typography_default_fonts', $fonts );
	}
}

define( 'DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Kanit:100,100italic,200,200italic,300,300italic,regular,italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic|Nunito:200,200italic,300,300italic,regular,italic,600,600italic,700,700italic,800,800italic,900,900italic' );
