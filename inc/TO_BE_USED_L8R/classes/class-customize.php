		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', '__THEMENAE__' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', '__THEMENAE__' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', '__THEMENAE__' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', '__THEMENAE__' ),
						'full'    => esc_html__( 'Full text', '__THEMENAE__' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', '__THEMENAE__' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
