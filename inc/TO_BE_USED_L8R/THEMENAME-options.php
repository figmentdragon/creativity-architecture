 ...
 */
 ...
 function theme_options( $wp_customize ) {
 	...
 	register_option( $wp_customize,
  array(
 			'name'              => 'latest_posts_title',
 			'default'           => esc_html__( 'News', '__THEMENAE__' ),
 			'sanitize_callback' => 'wp_kses_post',
 			'label'             => esc_html__( 'Latest Posts Title', '__THEMENAE__' ),
 	...
 	$wp_customize->add_section( 'layout_options', array(
 		'title' => esc_html__( 'Layout Options', '__THEMENAE__' ),
 		'panel' => 'theme_options',
 		)
 	);
  ...
  array(
 			...
 			'label'             => esc_html__( 'Default Layout', '__THEMENAE__' ),
 			'section'           => 'layout_options',
 			'type'              => 'radio',
 			'choices'           => array(
 				'right-sidebar'         => esc_html__( 'Right Sidebar ( Content, Primary Sidebar )', '__THEMENAE__' ),
 				'no-sidebar'            => esc_html__( 'No Sidebar', '__THEMENAE__' ),
 			),
 		)
 	);
 	...
 	register_option( $wp_customize, array(
 			...
 			'default'           => 'right-sidebar',
 			'sanitize_callback' => 'sanitize_select',
 			'label'             => esc_html__( 'Homepage/Archive Layout', '__THEMENAE__' ),
 			'section'           => 'layout_options',
 			'type'              => 'radio',
 			'choices'           => array(
 				'right-sidebar'         => esc_html__( 'Right Sidebar ( Content, Primary Sidebar )', '__THEMENAE__' ),
 	...
 	// Excerpt Options.
 	$wp_customize->add_section( 'excerpt_options',
   array(
 		'panel'     => 'theme_options',
 		'title'     => esc_html__( 'Excerpt Options', '__THEMENAE__' ),
 	) );
 	register_option( $wp_customize, array(
 			'name'              => 'excerpt_length',
 			'default'           => '20',
 			...
 			'label'    => esc_html__( 'Excerpt Length (words)', '__THEMENAE__' ),
 	...
 	register_option( $wp_customize, array(
 			...
 			'default'           => esc_html__( 'Continue reading', '__THEMENAE__' ),
 			'sanitize_callback' => 'sanitize_text_field',
 			'label'             => esc_html__( 'Read More Text', '__THEMENAE__' ),
 			'section'           => 'excerpt_options',
 			'type'              => 'text',
 		)
 	);
 	...
 	$wp_customize->add_section( 'search_options', array(
 		'panel'     => 'theme_options',
 		'title'     => esc_html__( 'Search Options', '__THEMENAE__' ),
 	) );
 	register_option( $wp_customize, array(
 			'name'              => 'search_text',
 			'default'           => esc_html__( 'Search', '__THEMENAE__' ),
 			'sanitize_callback' => 'sanitize_text_field',
 			'label'             => esc_html__( 'Search Text', '__THEMENAE__' ),
 	...
 	$wp_customize->add_section( 'homepage_options', array(
 		'description' => esc_html__( 'Only posts that belong to the categories selected here will be displayed on the front page', '__THEMENAE__' ),
 		'panel'       => 'theme_options',
 		'title'       => esc_html__( 'Homepage / Frontpage Options', '__THEMENAE__' ),
 	) );
 	register_option( $wp_customize, array(
 			'name'              => 'static_page_heading',
 			'sanitize_callback' => 'sanitize_text_field',
 			'active_callback'	=> 'is_static_page_enabled',
 			'default'           => esc_html__( 'Archives', '__THEMENAE__' ),
 			'label'             => esc_html__( 'Posts Page Header Text', '__THEMENAE__' ),
 	...
 	register_option( $wp_customize, array(
 			...
 			'label'             => esc_html__( 'Categories', '__THEMENAE__' ),
 			'section'           => 'homepage_options',
 	...
 	*/
 	$nav_desc = sprintf(
 		wp_kses(
 			__( 'For infinite scrolling, use %1$sCatch Infinite Scroll Plugin%2$s with Infinite Scroll module Enabled.', '__THEMENAE__' ),
 			array(
 				'a' => array(
 					'href' => array(),
 					'target' => array(),
 	...
 	$wp_customize->add_section( 'pagination_options', array(
 		...
 		'panel'           => 'theme_options',
 		'title'           => esc_html__( 'Pagination Options', '__THEMENAE__' ),
 	...
 	register_option( $wp_customize, array(
 			...
 			'label'             => esc_html__( 'Pagination type', '__THEMENAE__' ),
 	...
 	/* Scrollup Options */
  $wp_customize->add_section( 'scrollup',
  array(
    'panel'    => 'theme_options',
 		'title'    => esc_html__( 'Scrollup Options', '__THEMENAE__' ),
    )
  );
...
register_option( $wp_customize,
  array(
    ...
    'label'             => sprintf( esc_html__( 'For Scroll Up, install %1$sTo Top%2$s Plugin', '__THEMENAE__' ),
 ...
 /**
  * Returns an array of avaliable fonts registered for THEMENAE
  *
  * @since THEMENAE 1.0
  */
