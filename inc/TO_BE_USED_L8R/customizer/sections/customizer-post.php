...
function THEMENAME_customize_register_post_settings( $wp_customize ) {
	...
	$wp_customize->add_section( 'THEMENAME_section_post', array(
		'title'    => esc_html__( 'Post Settings', '__THEMENAE__' ),
		'priority' => 40,
	...
	$wp_customize->add_control( 'THEMENAME_single_layout', array(
		'label'    => esc_html__( 'Full Post Layout', '__THEMENAE__' ),
		'description' => esc_html__( 'This will let you choose your full post layout.', '__THEMENAE__' ), 
		'section'  => 'THEMENAME_section_post',
		'type'     => 'radio',
		'choices'  => array(
			'single-default' => esc_html__( 'Post With Sidebar', '__THEMENAE__' ),
			'single-centered' => esc_html__( 'Post Full Width Centered No Sidebar', '__THEMENAE__' ),	
		),
	) );	
	...
	$wp_customize->add_control( new THEMENAME_Customize_Header_Control(
		$wp_customize, 'THEMENAME_theme_options[single_post]', array(
			'label' => esc_html__( 'Show or Hide Post Elements', '__THEMENAE__' ),
			'section' => 'THEMENAME_section_post',
			'settings' => array(),
		)
	) );
	...
	$wp_customize->add_control( 'THEMENAME_show_single_image', array(
		'label'    => esc_html__( 'Hide Full Post Featured Image', '__THEMENAE__' ),
		'section'  => 'THEMENAME_section_post',
		'type'     => 'checkbox',
	) );	
	...
	$wp_customize->add_control( 'THEMENAME_single_meta_info', array(
		'label'    => esc_html__( 'Hide Full Post Meta Info', '__THEMENAE__' ),
		'section'  => 'THEMENAME_section_post',
		'type'     => 'checkbox',
	) );		
	...
	$wp_customize->add_control( 'THEMENAME_show_single_author', array(
		'label'    => esc_html__( 'Hide Full Post By Author', '__THEMENAE__' ),
		'section'  => 'THEMENAME_section_post',
		'type'     => 'checkbox',
	) );
	...
	$wp_customize->add_control( 'THEMENAME_show_single_date', array(
		'label'    => esc_html__( 'Hide Full Post Date', '__THEMENAE__' ),
		'section'  => 'THEMENAME_section_post',
		'type'     => 'checkbox',
	) );
	...
	$wp_customize->add_control( 'THEMENAME_show_single_comments', array(
		'label'    => esc_html__( 'Hide Full Post Comment Count', '__THEMENAE__' ),
		'section'  => 'THEMENAME_section_post',
		'type'     => 'checkbox',
	) );			
	...
	$wp_customize->add_control( 'THEMENAME_footer_categories', array(
		'label'    => esc_html__( 'Hide Categories', '__THEMENAE__' ),
		'section'  => 'THEMENAME_section_post',
		'type'     => 'checkbox',
	) );
	...
	$wp_customize->add_control( 'THEMENAME_footer_tags', array(
		'label'    => esc_html__( 'Hide Tags', '__THEMENAE__' ),
		'section'  => 'THEMENAME_section_post',
		'type'     => 'checkbox',
	) );		
	...
	$wp_customize->add_control( 'THEMENAME_display_author_bio', array(
		'label'    => esc_html__( 'Hide Author Bio', '__THEMENAE__' ),
		'section'  => 'THEMENAME_section_post',
		'type'     => 'checkbox',
	) );	
	...
	$wp_customize->add_control( 'THEMENAME_post_navigation', array(
		'label'    => esc_html__( 'Hide previous/next post navigation', '__THEMENAE__' ),
		'section'  => 'THEMENAME_section_post',
		'type'     => 'checkbox',
	) );
