...
function customize_register_basic_settings( $wp_customize ) {
	...
	$wp_customize->add_section( 'section_basic', array(
			'title'    => esc_html__( 'Basic Settings', '__THEMENAE__' ),
			'priority' => 8,
			'panel' => 'options_panel',
		) );
	...
	$wp_customize->add_control( 'copyright', array(
			'label'    => esc_html__( 'Copyright Name', '__THEMENAE__' ),
	...
	$wp_customize->add_control( 'attachment_comments', array(
			'label'    => esc_html__( 'Enable Gallery View Comments', '__THEMENAE__' ),
			'section'  => 'section_basic',
			'type'     => 'checkbox',
		) );
	...
	$wp_customize->add_setting( 'default_google_fonts',array(
		'default'           => true,
		'description' 			=> esc_html__( 'This theme has a couple Google Fonts included. If you choose to use a plugin for different fonts, you can disable them.', '__THEMENAE__' ),
		'sanitize_callback' => 'sanitize_checkbox',
	)	);
}
...
$wp_customize->add_control( new Customize_Header_Control(
	$wp_customize, 'theme_options[basic_options]',array(
			'label' => esc_html__( 'WP Gallery Options', '__THEMENAE__' ),
			'section' => 'section_basic',
			'settings' => array(),
		) );
...
$wp_customize->add_control(	new Customize_Header_Control(
		$wp_customize, 'google_fonts_option', array(
			'label' => esc_html__( 'Default Google Font Option', '__THEMENAE__' ),
			'section' => 'section_basic',
			'settings' => array(),
		) );
...
$wp_customize->add_control( new	Customize_Header_Control(
	$wp_customize, 'default_google_fonts',.array(
		'label' => esc_html__( 'Default Google Fonts', '__THEMENAE__' ),
		'section' => 'section_basic',
		'settings' => array(),
	) );
}
