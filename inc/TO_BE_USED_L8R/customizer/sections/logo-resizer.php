...
function THEMENAME_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'logo_size', array(
		'label'       => esc_html__( 'Logo Size', '__THEMENAE__' ),
...
function THEMENAME_logo_customize_preview_js() {
	wp_enqueue_script( 'logo-customizer', get_template_directory_uri() . '/customizer/js/logo/customize-preview.js', array( 'jquery', 'customize-preview' ), '201709081119', true );
}
...
function THEMENAME_logo_customize_controls_js() {
		wp_enqueue_script( 'logo-customizer-controls', get_template_directory_uri() . '/customizer/js/logo/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
