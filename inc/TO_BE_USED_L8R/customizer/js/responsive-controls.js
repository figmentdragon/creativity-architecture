jQuery(document).ready(function ($) {
	...
	/**
	 * Sync device preview button from WordPress to _THEMENAE_ and vice versa.
	 */
	...
	/**
	 * Setup _THEMENAE_ device preview.
	 *
	...
	// Loop through _THEMENAE_ device buttons and assign the event.
