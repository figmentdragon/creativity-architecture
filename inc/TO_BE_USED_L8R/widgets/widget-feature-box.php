    ...
    public function __construct() {
        parent::__construct(
            'feature_box', 'AP : Feature Textbox', array(
                'description' => __('A widget to display feature textbox', '__THEMENAE__')
            )
        );
    }
