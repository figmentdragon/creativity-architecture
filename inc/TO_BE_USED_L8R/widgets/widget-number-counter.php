...
function register_number_counter_widgets() {
    register_widget( 'WP_THEMENAE_Number_Counter' );
}

class WP_THEMENAE_Number_Counter extends WP_Widget {

    /* Register Widget with WordPress */
    function __construct() {
        parent::__construct(
            'number-counter',
            __( 'AP: Number Counter', '__THEMENAE__' ),
            array( 'classname' => 'number-counter', 'description' => __( 'Number Animation Conter', '__THEMENAE__' ) )
        );
    }
	 ...
	 */
	 private function widget_fields() {
		$fields = array(
			'counter_title' => array(
                'widgets_name' => 'counter_title',
                'widgets_title' => __('Title','__THEMENAE__'),
                'widgets_field_type' => 'text'
            ),
            'counter' => array(
                'widgets_name' => 'counter',
                'THEMENAMEc_widgets_title' => __('Counter','__THEMENAE__'),
                'widgets_field_type' => 'number'
            ),
		);
    ...
    public function widget( $args, $instance ) {
        ...
        ?>
            <div class="counter-wrap widget_number-counter clearfix">
    ...
    public function form( $instance ) {
        ...
        ?>
            ...
            <?php esc_html__('Counter Title', '__THEMENAE__'); ?>
            </label>
            ...
            <?php esc_html__('Counter Number', '__THEMENAE__'); ?>
            </label>
            ...
            <div class="startKnob" style="display: none;"><?php esc_html__( 'start', '__THEMENAE__' ); ?></div>
