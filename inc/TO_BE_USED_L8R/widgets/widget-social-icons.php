...
class socialicon_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct('social', /* Unique widget ID */
			esc_html__('THEMENAE - Social Media URL', '__THEMENAE__'), /* Widget title display in widget area. */
			array( 'description' => esc_html__( 'Social media URL widget.', '__THEMENAE__' ), ) /* Widget description */
		);
	}
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_style' )); ?>">
			<?php esc_html_e( 'Social Button Style', '__THEMENAE__' ); ?>
		</label>
		<select class="widefat" id="<?php echo esc_attr($this->get_field_id( 'button_style')); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_style')); ?>" style="width:100%;">
			<option value="<?php echo esc_attr('default-colors')?>" <?php selected( $button_style, 'default-colors' );?>><?php esc_html_e( 'Default Color', '__THEMENAE__' ) ?></option>
			<option value="<?php echo esc_attr('theme-colors')?>" <?php  selected( $button_style, 'theme-colors' ); ?>><?php esc_html_e( 'Theme Color', '__THEMENAE__' ) ?></option>
			<option value="<?php echo esc_attr('original-colors')?>" <?php selected( $button_style, 'original-colors' );  ?>><?php esc_html_e( 'Icon Original Color', '__THEMENAE__' ) ?></option>
		</select>
	</p>

	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'fb_url' )); ?>"><?php esc_html_e( 'Facebook URL', '__THEMENAE__' ); ?></label>
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id('twitter_url')); ?>"><?php esc_html_e('Twitter URL', '__THEMENAE__' ); ?></label>
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id('instagram_url')); ?>"><?php esc_html_e( 'Instagram URL', '__THEMENAE__' ); ?></label>
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'linkedin_url')); ?>"><?php esc_html_e( 'Linkedin URL', '__THEMENAE__' ); ?></label>
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'github_url' )); ?>"><?php esc_html_e( 'GitHub URL', '__THEMENAE__' ); ?></label>
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'youtube_url' )); ?>"><?php esc_html_e( 'YouTube URL', '__THEMENAE__' ); ?></label>
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'pinterest_url' )); ?>"><?php esc_html_e( 'Pinterest URL', '__THEMENAE__' ); ?></label>
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'dribble_url' )); ?>"><?php esc_html_e('Dribble URL', '__THEMENAE__' ); ?></label>
