...
function featured_image( $post_id = NULL, $thmbSize = '', $attr=NULL ) {
    ...
    if ( has_post_thumbnail($post_id) ) {
		...
		printf('<div  class="entry-media" >
				...
				</div>',esc_url(get_permalink($post_id)), esc_attr(sprintf( __( 'Permalink to: "%s"', '__THEMENAE__' ), get_the_title($post_id) ) ), $thumb );
