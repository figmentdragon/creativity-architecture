...
function fonts_url() {
	...
	*/
	...
	$raleway     = _x( 'on', 'Raleway font: on or off', '__THEMENAE__' );
	$roboto      = _x( 'on', 'Roboto font: on or off', '__THEMENAE__' );
	$open_sans   = _x( 'on', 'Open Sans font: on or off', '__THEMENAE__' );
	$montserrat  = _x( 'on', 'Montserrat font: on or off', '__THEMENAE__' );
	$droid_serif = _x( 'on', 'Droid Serif font: on or off', '__THEMENAE__' );
	$cabin       = _x( 'on', 'Cabin font: on or off', '__THEMENAE__' );
	$lato        = _x( 'on', 'Lato font: on or off', '__THEMENAE__' );
