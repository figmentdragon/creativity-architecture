...
/*************************************/
	...
	'name'          => __( 'Primary Sidebar', '__THEMENAE__' ),
	'id'            => 'primary-sidebar',
	'description'   => __('Primary sidebar of the theme. Display on left or right side of the theme','__THEMENAE__'),
    'class'         => '',
...
/**********************************************************/
	...
	while ( $counter < $number_of_widgets ) : $counter++;
		...
		register_sidebar( array(
			'name'          => __( 'Footer ', '__THEMENAE__' ) . $counter,
			'id'            => 'footer-' . $counter,
			'description'   => __( 'Footer bottom area vertical widgets.', '__THEMENAE__' ),
