...
function create_expertise_taxonomy()
{
  ...
  register_taxonomy_for_object_type('tax_expertise', 'case');
  register_taxonomy_for_object_type('tax_expertise', 'job');
}

add_action('init', __NAMESPACE__ . '\\create_expertise_taxonomy');
...
{
  register_taxonomy_for_object_type('expertise', 'attachment');
}

//add_action( 'init' , __NAMESPACE__ . '\\add_taxonomies_to_attachments' );
