...
function customize_register($wp_customize)
{
  ...
  $wp_customize->add_section(
    'projects_section',
    [
      'title'    => __('Projects', '__THEMENAE__'),
      'priority' => 30,
    ]
  );
  ...
  $wp_customize->add_section(
    'social_section',
    [
      'title'    => __('Social Media', '__THEMENAE__'),
      'priority' => 30,
    ]
  );
  ...
  $wp_customize->add_control(
    new \WP_Customize_Control(
      ...
      'projects_page_id',
      [
        'label'    => __('Side "Project":', '__THEMENAE__'),
  ...
  $wp_customize->add_control(
    new \WP_Customize_Control(
      ...
      'social_fb_url',
      [
        'label'    => __('URL Facebook', '__THEMENAE__'),
  ...
  $wp_customize->add_control(
    new \WP_Customize_Control(
      ...
      'social_xing_url',
      [
        'label'    => __('URL XING', '__THEMENAE__'),
        'section'  => 'social_section',
  ...
  $wp_customize->add_control(
    new \WP_Customize_Control(
      ...
      'social_linkedin_url',
      [
        'label'    => __('URL LinkedIn', '__THEMENAE__'),
        'section'  => 'social_section',
