<?php
/* Welcome to THEMENAE :)
This is the core THEMENAE file where most of the
...
function theme_support() {
	...
	register_nav_menus(
		array(
			'main-nav' => __( 'The Main Menu', '__THEMENAE__' ),   // main nav in header
			'footer-links' => __( 'Footer Links', '__THEMENAE__' ) // secondary nav in footer
		)
	);
...
function related_posts() {
	...
	if($tags) {
		...
		if($related_posts) {
			...
			<?php echo '<li class="no_related_post">' . __( 'No Related Posts Yet!', '__THEMENAE__' ) . '</li>'; ?>
		<?php }
	}
	wp_reset_postdata();
	echo '</ul>';
} /* end THEMENAE related posts function */
