 ...
 * );
 * return $custom_menu_fields;
 * });
 *              You can use this custom data in your Nav Walker's function start_el():
 *
 * if (isset($item->custom_fields) && !empty($item->custom_fields['my_custom_field'])) {
 * $classes = ' class="' . $item->custom_fields['my_custom_field'] . '"';
 * }
 *
 * @todo        Make the walker class use less of the core code
 *
 */
...
{
  $menu_item->custom_fields = get_post_meta($menu_item->ID, '_menu_item_custom_fields', true) ?: [];
  ...
  <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes); ?>">
    ...
    <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
        ...
        <p class="field-url description description-wide">
          <label for="edit-menu-item-url-<?php echo $item_id; ?>">
            ...
            <input type="text" id="edit-menu-item-url-<?php echo $item_id; ?>" class="widefat code edit-menu-item-url"
                   name="menu-item-url[<?php echo $item_id; ?>]" value="<?php echo esc_attr($item->url); ?>"/>
          </label>
        </p>
      <?php endif; ?>
      <p class="description description-thin">
        <label for="edit-menu-item-title-<?php echo $item_id; ?>">
          ...
          <input type="text" id="edit-menu-item-title-<?php echo $item_id; ?>" class="widefat edit-menu-item-title"
                 name="menu-item-title[<?php echo $item_id; ?>]" value="<?php echo esc_attr($item->title); ?>"/>
        </label>
      </p>
      <p class="description description-thin">
      ...
      <p class="field-xfn description description-thin">
        <label for="edit-menu-item-xfn-<?php echo $item_id; ?>">
          ...
          <input type="text" id="edit-menu-item-xfn-<?php echo $item_id; ?>" class="widefat code edit-menu-item-xfn"
                 name="menu-item-xfn[<?php echo $item_id; ?>]" value="<?php echo esc_attr($item->xfn); ?>"/>
        </label>
      </p>
      <p class="field-description description description-wide">
        <label for="edit-menu-item-description-<?php echo $item_id; ?>">
          ...
          <textarea id="edit-menu-item-description-<?php echo $item_id; ?>" class="widefat edit-menu-item-description"
                    rows="3" cols="20" name="menu-item-description[<?php echo $item_id; ?>]"><?php echo esc_html(
              $item->description
            ); // textarea_escaped
            ?></textarea>
      ...
      foreach ($custom_menu_fields as $idx => $custom_menu_field):
        ...
        $old_value = isset($item->custom_fields[$idx]) ? $item->custom_fields[$idx] : '';

        ?><p class="field-custom description description-wide">
        <label for="edit-menu-item-<?= $idx ?>-<?php echo $item_id; ?>">
          <?= $custom_menu_field['label'] ?><br/>
          <input type="text" id="edit-menu-item-custom-fields-<?php echo $item_id; ?>"
                 class="widefat code edit-menu-item-custom-fields"
                 name="menu-item-custom-fields[<?php echo $item_id; ?>][<?= $idx ?>]"
      ...
      <div class="menu-item-actions description-wide submitbox">
        ...
        echo wp_nonce_url(
          ...
          'delete-menu_item_'.$item_id
                                                                               ...
                                                                               ?>#menu-item-settings-<?php echo $item_id; ?>"><?php _e(
            'Cancel'
          ); ?></a>
      </div>
