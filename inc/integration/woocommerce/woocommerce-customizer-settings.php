...
function woo_customizer_setup( $wp_customize ) {
	...
	$wp_customize->get_section( 'woocommerce_product_catalog' )->title = __( 'Shop Page', 'THEMENAME' );
...
Kirki::add_section( 'woocommerce_product_options', array(
	'title'    => __( 'Product Page', 'THEMENAME' ),
	'panel'    => 'woocommerce',
	'priority' => 40,
) );
...
Kirki::add_field( 'themename', array(
	...
	'description' => __( 'Display Menu Item only on WooCommerce related pages', 'THEMENAME' ),
...
Kirki::add_field( 'themename', array(
	...
	'label'       => __( 'Product Search', 'THEMENAME' ),
	'description' => __( 'Turn the Search Menu Item into a Product Search', 'THEMENAME' ),
	'section'     => 'woocommerce_menu_item_options',
	'default'     => 0,
	'priority'    => 5,
) );
...
Kirki::add_field( 'themename', array(
	'type'        => 'dimension',
	'label'       => __( 'Custom Content Width', 'THEMENAME' ),
	'settings'    => 'woocommerce_single_custom_width',
	'section'     => 'woocommerce_product_options',
	'description' => __( 'Default: 1200px', 'THEMENAME' ),
...
Kirki::add_field( 'themename', array(
	...
	'label'     => __( 'Image Alignment', 'THEMENAME' ),
	'section'   => 'woocommerce_product_options',
	'default'   => 'left',
	'priority'  => $product_priority++,
	'multiple'  => 1,
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Disable Gallery Zoom', 'THEMENAME' ),
	'section'  => 'woocommerce_product_options',
	'priority' => $product_priority++,
	'default'  => false,
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Disable Gallery Slider', 'THEMENAME' ),
	'section'  => 'woocommerce_product_options',
	'priority' => $product_priority++,
	'default'  => false,
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Disable Gallery Lightbox', 'THEMENAME' ),
	'section'  => 'woocommerce_product_options',
	'priority' => $product_priority++,
	'default'  => false,
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Summary Separator', 'THEMENAME' ),
	'section'  => 'woocommerce_product_options',
	'default'  => 'hide',
	'priority' => $product_priority++,
	'choices'  => array(
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Price Quantity Buttons (+/-)', 'THEMENAME' ),
	'section'  => 'woocommerce_product_options',
	'default'  => 'show',
	'priority' => $product_priority++,
	'choices'  => array(
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Tabs Layout', 'THEMENAME' ),
	'section'  => 'woocommerce_product_options',
	'default'  => 'default',
	'priority' => $product_priority++,
	'multiple' => 1,
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Enable AJAX add to cart button', 'THEMENAME' ),
	'section'  => 'woocommerce_product_options',
	'priority' => $product_priority++,
	'default'  => false,
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'           => __( 'Store Notice', 'THEMENAME' ),
...
Kirki::add_field( 'themename', array(
	...
	'label'     => __( 'Info Notice', 'THEMENAME' ),
	'section'   => 'woocommerce_store_notice',
	'priority'  => 100,
	'transport' => 'postMessage',
	'choices'   => array(
...
Kirki::add_field( 'themename', array(
	...
	'label'     => __( 'Success Notice', 'THEMENAME' ),
	'section'   => 'woocommerce_store_notice',
	'default'   => '#4fe190',
	'priority'  => 100,
	'transport' => 'postMessage',
...
Kirki::add_field( 'themename', array(
	...
	'label'     => __( 'Error Notice', 'THEMENAME' ),
	'section'   => 'woocommerce_store_notice',
	'default'   => '#ff6347',
	'priority'  => 100,
	'transport' => 'postMessage',
...
Kirki::add_field( 'themename', array(
	...
	'label'     => __( 'Notice Bg Color', 'THEMENAME' ),
	'section'   => 'woocommerce_store_notice',
	'priority'  => 100,
	'transport' => 'postMessage',
	'choices'   => array(
...
Kirki::add_field( 'themename', array(
	...
	'label'     => __( 'Notice Text Color', 'THEMENAME' ),
	'section'   => 'woocommerce_store_notice',
	'priority'  => 100,
	'transport' => 'postMessage',
	'choices'   => array(
...
Kirki::add_field( 'themename', array(
	...
	'choices'  => array(
		'default' => __( 'Default', 'THEMENAME' ),
		'side'    => __( 'Side by Side', 'THEMENAME' ),
	),
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Hide Page Title', 'THEMENAME' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => 0,
	'priority' => $shop_priority++,
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Hide Breadcrumbs', 'THEMENAME' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => 0,
	'priority' => $shop_priority++,
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Hide Result Count', 'THEMENAME' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => 0,
	'priority' => $shop_priority++,
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Hide Ordering', 'THEMENAME' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => 0,
	'priority' => $shop_priority++,
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Products per Row', 'THEMENAME' ),
	'section'  => 'woocommerce_product_catalog',
	'priority' => $shop_priority++,
	'default'  => json_encode(
		array(
...
Kirki::add_field( 'themename', array(
	...
	'choices'  => array(
		...
		'xlarge'   => __( 'xLarge', 'THEMENAME' ),
		'collapse' => __( 'Collapse', 'THEMENAME' ),
	),
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'     => __( 'Content Alignment', 'THEMENAME' ),
	'section'   => 'woocommerce_product_catalog',
	'default'   => 'left',
	'priority'  => $shop_priority++,
	'multiple'  => 1,
...
Kirki::add_field( 'themename', array(
	...
	'choices'  => array(
		...
		'rating'      => __( 'Rating', 'THEMENAME' ),
		'price'       => __( 'Price', 'THEMENAME' ),
		'add_to_cart' => __( 'Add to Cart Button', 'THEMENAME' ),
		'excerpt'     => __( 'Short Description', 'THEMENAME' ),
	),
	'priority' => $shop_priority++,
) );
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Sale Badge', 'THEMENAME' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => 'outside',
	'priority' => $shop_priority++,
	'multiple' => 1,
	'choices'  => array(
		'none'    => __( 'Hide', 'THEMENAME' ),
		'outside' => __( 'Outside', 'THEMENAME' ),
		'inside'  => __( 'Inside', 'THEMENAME' ),
	),
) );
...
Kirki::add_field( 'themename', array(
	...
	'multiple'        => 1,
	'choices'         => array(
		'round'  => __( 'Round', 'THEMENAME' ),
		'square' => __( 'Square', 'THEMENAME' ),
	),
	'active_callback' => array(
		array(
...
Kirki::add_field( 'themename', array(
	'type'      => 'input_slider',
	'label'     => __( 'Title Font Size', 'THEMENAME' ),
...
Kirki::add_field( 'themename', array(
	'type'      => 'input_slider',
	'label'     => __( 'Price Font Size', 'THEMENAME' ),
...
Kirki::add_field( 'themename', array(
	...
	'label'    => __( 'Out of Stock Notice', 'THEMENAME' ),
	'section'  => 'woocommerce_product_catalog',
	'default'  => 'show',
	'priority' => $shop_priority++,
	'multiple' => 1,
