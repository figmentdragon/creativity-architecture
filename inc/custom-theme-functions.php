...
function my_login_logo() { ?>
	<style type="text/css">
		body.login div#login h1 a {
			background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/assets/images/logo/logo-architect.png);
			padding-bottom: 30px;
		}
...
function add_scripts() {
	...
	wp_enqueue_style( 'child-style',
 	...
 	if ( is_page('write') ) { // use on just our form page
		...
		wp_register_script( 'jquery.writer' , get_stylesheet_directory_uri() . '/js/jQuery/jquery.writer.js', 'suggest' , '1.23', TRUE );
    ...
    null , '1.0', TRUE );
		...
		wp_register_script( 'jquery.editlink' , get_stylesheet_directory_uri() . '/js/jQuery/jquery.editlink.js', null , '0.1', TRUE );
