...
class Customize_Responsive_Input_Slider extends Kirki\Control\Base {

	public $type = 'responsive-input-slider';

	public function enqueue() {
		wp_enqueue_script( 'responsive-input-slider', THEME_URI . '/inc/customizer/controls/responsive-input-slider/js/responsive-input-slider.js', array( 'jquery' ), VERSION, true );
	...
	public function render_content() {
		...
		echo '<div class="responsive-input-slider-wrap">';
		...
		printf(
			'<input type="hidden" class="responsive-input-slider-db" name="%s" value="%s" %s/>',
...
add_filter( 'kirki_control_types', function ( $controls ) {
		...
		$controls['responsive_input_slider'] = 'Customize_Responsive_Input_Slider';
