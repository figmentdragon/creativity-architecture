...
class Customize_Font_Size_Control extends Kirki\Control\Base {

	public $type = 'responsive-input';

	public function enqueue() {
		wp_enqueue_script( 'responsive-input', THEME_URI . '/inc/customizer/controls/responsive-input/js/responsive-input.js', array( 'jquery' ), VERSION, true );
	}
	...
	public function render_content() {
		...
		echo '<div class="responsive-input-wrap">';
		...
		printf(
			'<input type="hidden" class="responsive-input-db" name="%s" value="%s" %s/>',
...
add_filter( 'kirki_control_types', function ( $controls ) {
		...
		$controls['responsive_input'] = 'Customize_Font_Size_Control';
