 ...
 * @version   2.6.1 for parent theme MYTHEME Pro for publication on WordPress.org
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			$this->strings = array(
				...
				'activated_successfully'          => __( 'This plugin was activated successfully:', 'MYTHEME' ),
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		protected function get_plugin_status_text( $slug ) {
			...
			return sprintf(
				...
				_x( '%1$secondary, %2$s', 'Install/Update Status', 'MYTHEME' ),
				$install_status,
				$update_status
			);
		}
