...
function theme_settings_page() {
	...
	add_theme_page( __( 'Theme Settings', 'THEMENAME' ), __( 'Theme Settings', 'THEMENAME' ), 'manage_options', 'premium', 'theme_settings_callback' );
...
function show_activation_notice() {
	...
	if ( ! empty( get_option( 'activation_notice_dismissed', 0 ) ) ) {
		return;
	}
...
function show_bfcm_notice() {
    ...
    // Stop if we are not on the dashboard or themename settings page.
