...
( function() {
	...
	wp.customize( 'background_color', function( value ) {
		value.bind( function( to ) {
			var lum = architectureGetHexLum( to ),
				isDark = 127 > lum,
				...
				stylesheetID = 'architecture-customizer-inline-styles',
				stylesheet,
				styles;
			...
			if ( ! stylesheet.length ) {
				jQuery( '#architecture-style-inline-css' ).after( '<style id="' + stylesheetID + '"></style>' );
				stylesheet = jQuery( '#' + stylesheetID );
			}
