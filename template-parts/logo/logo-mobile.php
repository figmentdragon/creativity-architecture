...
if ( has_custom_logo() ) {
	...
	$custom_logo_url  = apply_filters( 'logo_mobile', $custom_logo_data[0] );
	...
	echo '<div class="mobile-logo" itemscope="itemscope" itemtype="https://schema.org/Organization">';
	do_action( 'before_mobile_logo' );
